    ...
    <Layout user={user || undefined} onLogout={handleLogout}> {/* Fixed: Handle null/undefined */}
      <div className="space-y-6">
        ...
        <DashboardStats
          ...
          totalOrganizations={orgMetrics.totalOrganizations || 0} // Fixed access
          totalUsers={userMetrics.totalUsers || 0} // Fixed access
          isAdmin={hasAdminAccess}
        />
          ...
          {canUploadDocuments && (
            <TabsContent value="upload">
              <DocumentUpload
                onUpload={handleUpload}
                organizations={organizations}
                currentUserOrg={user.organization || undefined} // Fixed: Handle null
                loading={uploadLoading}
                error={uploadError}
                success={uploadSuccess}
              />
