...
>(({ id, className, children, config, ...props }, ref) => {
  ...
  return (
    <useChart.Provider value={{ config }}>
      <div
        data-chart={chartId}
        ref={ref}
        className={cn(
...
type ExtendedTooltipProps = React.ComponentProps<
...
>(
  (
    ...
    const { config } = useContext(useChart);
...
const ChartLegendContent = React.forwardRef<
  HTMLDivElement,
  React.ComponentProps<"div"> & CustomLegendProps
>(
  (
