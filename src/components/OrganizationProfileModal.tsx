...
// // export const OrganizationProfileModal = ({ user, isOpen, onClose, onSuccess }: OrganizationProfileModalProps) => {
...
// //   const organizations: Organization[] = orgsData?.data?.organizations || orgsData?.organizations || [];
...
// //     createOrgMutation.mutate({ name: newOrgName.trim(), organizationType: newOrgType });
// //   };
...
// //           </DialogTitle>
// //           <DialogDescription>
// //             Manage your personal details and assign an organization for document access.
// //           </DialogDescription>
// //         </DialogHeader>
...
// //                 <Select value={formData.dateFormat} onValueChange={(val) => handleSelectChange("dateFormat", val)}>
// //                   <SelectTrigger>
...
// //                     disabled={!newOrgName.trim() || createOrgMutation.isPending || isCreatingOrg}
// //                     variant="outline"
// //                     size="sm"
// //                   >
...
// //                     </SelectTrigger>
// //                     <SelectContent>
// //                       {/* Fetch roles via query if needed */}
// //                       <SelectItem value="66e9b1a2f3b4c5d6e7f8a9b0">Super Admin</SelectItem>
// //                       {/* Add dynamic roles */}
// //                     </SelectContent>
// //                   </Select>
// //                 </div>
...
// //                   <Select value={formData.status} onValueChange={(val) => handleSelectChange("status", val as "Active" | "InActive")}>
// //                     <SelectTrigger>
// //                       <SelectValue />
// //                     </SelectTrigger>
// //                     <SelectContent>
...
// //               Cancel
// //             </Button>
// //             <Button type="submit" disabled={updateUserMutation.isPending || createOrgMutation.isPending}>
...
//   Plus,
//   FileText,
// } from "lucide-react"; // ADDED: FileText for potential document icon if needed
// import { userService, organizationService } from "../lib/api";
